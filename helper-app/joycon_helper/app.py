...
class App(tk.Tk):
    ...
    def _build_help_tab(self) -> None:
        ...
        _add("\U0001f50c  Wiring & Connections", [
            ...
            "\u2022 If you see garbage bytes: check common ground, baud rate (921600),",
        ...
        _add("\U0001f4be  Firmware Installation", [
            ...
            "  TX = GPIO17,  RX = GPIO16,  baud = 921600",
            "",
        ...
        _add("\U0001f3ae  Advanced Mapping Modes", [
            ...
            "",
            "## One-Shot (single-use modifier)",
            "Press once to arm; next key press applies the modifier once, then auto-releases.",
            "  JSON type: \"oneshot\"",
            "  Fields: mod, keycode",
            "  3-second timeout if no key follows. Up to 8 one-shot keys per profile.",
            "",
            "## Tap-Hold",
            ...
            "",
            "## Timing Humanization (anti-cheat)",
            "Macros use \u00b115% random jitter on delay steps.",
            "Turbo uses \u00b110% jitter on each press/release cycle.",
            "  Profile field: \"humanize\": true (default)",
            "  Serial command: set_humanize",
            "",
        ...
        _add("\U0001f4e1  Serial Protocol (Reference)", [
            ...
            "  Control (0xFE): set target, discovery, stick curve, calibration,",
            "    rumble, home LED, SOCD mode, rapid trigger",
        ...
        _add("\U0001f527  Troubleshooting", [
            ...
            "\u2022 Confirm baud rate is 921600 on both ends.",
