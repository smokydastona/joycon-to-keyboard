    ...
    return [
        ...
        (
            ...
            (
                ...
                "  Use a passive piezo only. Active buzzer modules with a built-in oscillator can turn this line into a constant tone instead of short chirps.\n"
                "  Current firmware hard-stops the PWM output when idle so the buzzer pin returns to a quiet low state between tones.\n"
        ...
        (
            ...
            (
                ...
                "## Constant buzzer tone / hum\n"
                "  Make sure the part on GPIO25 is a passive piezo, not an active buzzer module. Active modules can make a nonstop tone even when the firmware is not intentionally playing a melody.\n"
                "  Update to firmware that hard-stops the buzzer PWM while idle.\n"
                "  If the noise remains after disabling the buzzer in Bind Bandit, re-check the buzzer wiring and part type first.\n\n"
