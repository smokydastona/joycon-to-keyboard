    ...
    return [
        ...
        (
            ...
            (
                ...
                "Read/Upload Profile, Toggle Overlay), a per-side battery snapshot, an active-loadout briefing for the current slot, "
        ...
        (
            ...
            (
                ...
                "response curve in Operation Scripts → Stick."
            ),
            False,
        ),
        (
        ...
        (
            ...
            (
                ...
                "**Forger** (Mice and other pointing devices), and **Architect** (Ports / COM & LPT).\n"
