    ...
    return [
        ...
        (
            ...
            (
                ...
                "Help — you are here\n\n"
                "## Key Binding\n"
                "Click a hotspot on the controller image, then click a key in "
                "the quick-bind grid or type a custom keycode. Use Learn Mode "
                "to bind by pressing the actual key on the controller.\n\n"
                "## Profiles\n"
                "4 on-device profile slots. Use Import/Export to share as files "
                "or share codes (JCB1: prefix).\n\n"
                "## Overlay\n"
                "Toggle the floating overlay from Dashboard → Quick Actions "
                "to see active keys on-screen during gameplay."
            ),
            False,
        ),
        (
        ...
        (
            ...
            (
                ...
                "  Ctrl+S — Save current profile to device\n"
