    ...
    return [
        ...
        (
            ...
            (
                ...
                "  Passive piezo buzzer (optional — for audible connect/disconnect/error feedback)\n\n"
                "## Software\n"
        ...
        (
            ...
            (
                ...
                "  Provides audible BT connect/disconnect, discovery, and error tones.\n"
        ...
        (
            ...
            (
                ...
                "When a newer GitHub release is available a New Target button appears at\n"
                "the bottom of the left sidebar. Click it whenever you want to update;\n"
        ...
        (
            ...
            (
                ...
                "Bluetooth or PC USB HID devices (M913, Razer), quick actions (Ping, Toggle Overlay), "
                ...
                "directly in the mapping view when needed, with hotspot outlines shaped "
                "to match the keyboard keys instead of generic dots. "
                ...
                "- PC USB HID tab: lists supported devices (M913 keypad, Razer mice) currently "
                "plugged in via USB. Select one and click Add to register it.\n"
        ...
        (
            ...
            (
                ...
                "Settings, and Quit. The main status bar keeps connection, slot, "
                "undo depth, latency, and left/right battery telemetry visible even while you work in other tabs.\n\n"
