    ...
    return [
        ...
        (
            ...
            (
                ...
                "When a new release is available an ↑ Update button appears at\n"
                "the bottom of the sidebar. Click it to install the update;\n"
                "the app will restart and then flash new firmware automatically.\n\n"
