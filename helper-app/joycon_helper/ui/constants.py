...
INCEDIUS_HOTSPOTS: Dict[str, List[Tuple[str, float, float]]] = {
    "dark": [
        ...
        ("scroll_up",   0.543040, 0.502747),
        ("scroll_down", 0.530220, 0.608516),
        ("Thumb1",      0.355311, 0.291209),
        ("Thumb2",      0.413004, 0.254121),
        ("Thumb3",      0.463370, 0.233516),
        ("Thumb4",      0.403846, 0.325549),
        ("Thumb5",      0.456960, 0.304945),
        ("Thumb6",      0.444139, 0.372253),
        ("Finger1",     0.391941, 0.402473),
        ("Finger2",     0.336996, 0.358516),
        ("Finger3",     0.456914, 0.432866),
        ("Finger4",     0.392857, 0.472527),
        ("Finger5",     0.327839, 0.445055),
        ("Finger6",     0.391026, 0.563187),
    ],
    "default": [
        ("left",        0.585165, 0.633242),
        ("right",       0.604396, 0.515110),
