...
- UI mockup: see below
- UI background: `background.svg` — theme-matched background art (now includes `joycons.png` overlay layer).
- UI theme tokens: generated by `tools/generate_ui_bundle.py` as `theme.json`
