...
- `helper-app/` — **Bind Bandit** PC app (works standalone for M913 mouse config or Razer mouse config, or with the bridge hardware for Joy-Con profiles/logs, or any combination)
- `docs/` — wiring + notes
