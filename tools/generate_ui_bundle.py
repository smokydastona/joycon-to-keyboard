...
- backgrounds/: pre-rendered device-on-background PNGs (the app truth)
  ...
  - gamepad_{connected,none}.png
- gamepad.png: gamepad layout image used by the mapping editor
...
LIGHT_OVERLAYS = {
    ...
    "backgrounds/gamepad_connected.png": Path("docs/ui/default/backgrounds/gamepad_connected.png"),
    "backgrounds/gamepad_none.png": Path("docs/ui/default/backgrounds/gamepad_none.png"),
    "keyboard.png": Path("docs/ui/default/misc/keyboard.png"),
    "gamepad.png": Path("docs/ui/default/misc/gamepad.png"),
...
DARK_OVERLAYS = {
    ...
    "backgrounds/gamepad_connected.png": Path("docs/ui/dark/backgrounds/gamepad_connected.png"),
    "backgrounds/gamepad_none.png": Path("docs/ui/dark/backgrounds/gamepad_none.png"),
    "keyboard.png": Path("docs/ui/dark/misc/keyboard-dark.png"),
    "gamepad.png": Path("docs/ui/dark/misc/gamepad-dark.png"),
